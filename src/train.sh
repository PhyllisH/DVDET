...
#     --batch_size=4 --master_batch=1 --num_agents=5 --lr=5e-4 \
#     --gpus 1,2,3,4 --trans_layer -2 --num_epochs 50 --coord=Global \
...
# CUDA_VISIBLE_DEVICES=1,2,3,4 python main.py multiagent_det \
#     --exp_id dla_multiagent_withwarp_GlobalCoord_GTFeatMap_800_450_Down4_BEVGT_40m_Pointwise_Featmap16_RandomPickView_Updated  \
#     --batch_size=4 --master_batch=1 --num_agents=5 --lr=5e-4 \
#     --gpus 1,2,3,4 --trans_layer 2 --num_epochs 50 --coord=Global \
#     --message_mode=Pointwise --uav_height=40 --down_ratio=1 

#  CUDA_VISIBLE_DEVICES=1,2,3,4 python main.py multiagent_det \
#     --exp_id dla_multiagent_withwarp_GlobalCoord_GTFeatMap_800_450_Down4_BEVGT_40m_V2V_Featmap16_RandomPickView_Updated  \
#     --batch_size=4 --master_batch=1 --num_agents=5 --lr=5e-4 \
#     --gpus 1,2,3,4 --trans_layer 2 --num_epochs 50 --coord=Global \
...
CUDA_VISIBLE_DEVICES=1,2,3,4 python main.py multiagent_det \
    ...
    --message_mode=Max --uav_height=40 --down_ratio=1 \
    --resume \
    --load_model ../exp/multiagent_det/dla_multiagent_withwarp_GlobalCoord_GTFeatMap_800_450_Down4_BEVGT_40m_Max_Featmap4_RandomPickView_Updated/model_last.pth

CUDA_VISIBLE_DEVICES=1,2,3,4 python main.py multiagent_det \
    --exp_id dla_multiagent_withwarp_GlobalCoord_GTFeatMap_800_450_Down4_BEVGT_40m_Mean_Featmap4_RandomPickView_Updated  \
    --batch_size=4 --master_batch=1 --num_agents=5 --lr=5e-4 \
    --gpus 1,2,3,4 --trans_layer 0 --num_epochs 500 --coord=Global \
    --message_mode=Mean --uav_height=40 --down_ratio=1 
...
#     --batch_size=4 --master_batch=1 --num_agents=5 --lr=5e-4 \
#     --gpus 1,2,3,4 --trans_layer 0 --num_epochs 100 --coord=Global \
#     --message_mode=Max --uav_height=40 --down_ratio=1 \
#     --resume \
