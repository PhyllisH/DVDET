...
class DLASeg(nn.Module):
    ...
    def QUALITYMAP_MESSAGE(self, x, shift_mats, round, comm_thre=0.1, fusion='context', compress_flag=False):
        ...
        def _communication_graph_learning(val_feats, quality_maps, confidence_maps, round_id=0, thre=0.03, mask_on_feat=False):
            # val_feats: (b, k_agents, q_agents, c, h, w) 
            ...
            communication_maps_topk = communication_maps_topk * communication_mask
