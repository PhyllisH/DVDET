CUDA_VISIBLE_DEVICES=1,2,3,4,5,6 python main.py multiagent_det \
    --exp_id dla_multiagent_withwarp_GlobalCoord_GTFeatMap_512_512_Down4_BEVGT_40m_Baseline_Town5  \
    --batch_size=6 --master_batch=1 --num_agents=5 --lr=5e-4 \
    --gpus 1,2,3,4,5,6 --trans_layer -2 --num_epochs 100 --coord=Global \
    --message_mode=Pointwise --uav_height=40 --down_ratio=1 


CUDA_VISIBLE_DEVICES=1,2,3,4,5,6 python main.py multiagent_det \
    --exp_id dla_multiagent_withwarp_GlobalCoord_GTFeatMap_512_512_Down4_BEVGT_40m_Pointwise_Featmap16_RandomPickView_Town5  \
    --batch_size=6 --master_batch=1 --num_agents=5 --lr=5e-4 \
    --gpus 1,2,3,4,5,6 --trans_layer 2 --num_epochs 100 --coord=Global \
    --message_mode=Pointwise --uav_height=40 --down_ratio=1 

CUDA_VISIBLE_DEVICES=1,2,3,4,5,6 python main.py multiagent_det \
    --exp_id dla_multiagent_withwarp_GlobalCoord_GTFeatMap_512_512_Down4_BEVGT_40m_When2com_Featmap4_RandomPickView_Town5  \
    --batch_size=6 --master_batch=1 --num_agents=5 --lr=5e-4 \
    --gpus 1,2,3,4,5,6 --trans_layer 0 --num_epochs 100 --coord=Global \
