...
for i, metric in enumerate(metrics[:3]):
    ...
    plt.text(7, No_Message[i]* 100+0.2, 'NoCollaboration'.format(0,No_Message[i]* 100), ha='center', va='bottom', fontsize=fontsize)
    ...
    plt.text(max_volume-3, DiscoNet[i]* 100-0.9, 'DiscoNet'.format(max_volume,DiscoNet[i]* 100), ha='center', va='bottom', fontsize=fontsize)
    ...
    plt.text(Late_cost+6, LateFusion[i]* 100, 'LateFusion'.format(max_volume,LateFusion[i]* 100), ha='center', va='bottom', fontsize=fontsize)
...
for i, metric in enumerate(metrics[:3]):
    ...
    multi_agent_withthre_results = [x * 100 for x in multi_agent_withthre_results[i]]
    communication_volume_bytes = [math.log2(communication_volume * 32 // 8 * r) for r in communication_rates[:-1]] + [0]
    plt.plot(communication_volume_bytes[:-3], multi_agent_withthre_results[:-3], label='3 Rounds', linewidth=3)
    communication_rates = [1/x for x in communication_rates[:-1]] + [0]
    ...
    multi_agent_withthre_results = [x * 100 for x in multi_agent_withthre_results[i]]
    communication_volume_bytes = [math.log2(communication_volume * 32 // 8 * r) for r in communication_rates[:-1]] + [0]
    plt.plot(communication_volume_bytes[:-2], multi_agent_withthre_results[:-2], label='2 Rounds', linewidth=3)
    communication_rates = [1/x for x in communication_rates[:-1]] + [0]
    ...
    multi_agent_withthre_results = [x * 100 for x in multi_agent_withthre_results[i]]
    communication_volume_bytes = [math.log2(communication_volume * 32 // 8 * r) for r in communication_rates[:-1]] + [0]
    plt.plot(communication_volume_bytes[:-2], multi_agent_withthre_results[:-2], label='1 Round', linewidth=3, c='seagreen')
    communication_rates = [1/x for x in communication_rates[:-1]] + [0]
